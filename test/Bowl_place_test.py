...
class Demo:
    ...
    def pickup(self):
        ...
        self.gis.update_parent_link_of_group('bowl', 'hand_gripper_tool_frame')

        test.drive()
        #Try to force gripper to go to edge of bowl manually(?)
        self.gis.align_height(context=context, object_height=0.130, object_name=shape, goal_pose=self.box_pose)
        ...
        self.gis.retract(object_name='bowl', distance=0.25)
